...
function getMessage(passedMessage, name, lang) {
  ...
  var messageInSpecifiedLanguage = (0, _get.default)(
    (0, _languageLocale.default)(lang),
    name,
  );
  ...
  var messageInDefaultLanguage = (0, _get.default)(
    (0, _languageLocale.default)(),
    name,
  );
  ...
  var defaultMessageInSpecifiedLanguage = (0, _get.default)(
    (0, _languageLocale.default)(lang),
    'mixed.default',
  );
...
function createValidation(options) {
  ...
  function validate(_ref3) {
    ...
    var translatedMessage = getMessage(message, name, options.lang);
